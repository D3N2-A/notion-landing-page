...
import book from "../../../../public/Hero/Subhero/wiki.svg";

// Image imports for Carousel

import ai from "/Carousel/ai.png";
import docs from "/Carousel/docs.png";
import projects from "/Carousel/projects.png";
import wiki from "/Carousel/wiki.png";
...
function Subhero() {
  ...
  const [activeTab, setActiveTab] = useState({ title: "AI", image: ai });
  const svgSet = {
    sparkles: function () {
      return (
        <svg
        ...
        {tiles.map((tile, index) => {
          return (
            <div
              ...
              onMouseEnter={(e) => {
                setActiveTab((prev) => {
                  return { title: tile.title, image: tile.image };
                });
              }}
            >
              <div className="top">
